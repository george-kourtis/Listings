...
/**
 * The main application component. This component renders a form for creating a listing.
 * The form includes fields for title, type, area, price, levels, bathrooms, bedrooms, and property type.
 * The form also includes a dropdown for selecting the area of the property.
 * The component uses the useForm hook from react-hook-form to manage the form state and validation.
 * The component also uses the useFetchAreaData hook from ./hooks/useFetchAreaData to fetch the area data from the server.
 * The component renders a toaster notification when the form is submitted successfully.
 */
function App() {
  const {
    register,
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div>
          <AreaDropdown
            ...
            handleAreaValueChange={setSelectedArea}
